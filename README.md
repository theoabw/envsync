...
Download the archive for your OS and architecture from the repository's
Releases page, verify it against `checksums.txt`, and place `envsync` (or
`envsync.exe`) on your `PATH`.
